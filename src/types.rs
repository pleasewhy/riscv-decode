...
const FJ_IMM_19_12: u32 = 0b00000000000011111111000000000000; // j-type
const FJ_IMM_11: u32 = 0b00000000000100000000000000000000;
const FJ_IMM_10_1: u32 = 0b01111111111000000000000000000000;
const FJ_IMM_20: u32 = 0b10000000000000000000000000000000;
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
...
impl JType {
    ...
    pub fn imm_s_ext(&self) -> i32 {
        ...
        ret |= (self.0 & FJ_IMM_19_12) << 11;
        ret |= (self.0 & FJ_IMM_11) << 2;
        ret |= (self.0 & FJ_IMM_10_1) >> 9;
        ret as i32 >> 11
    }
    pub fn rd(&self) -> u32 {
        (self.0 >> 7) & 0x1f
